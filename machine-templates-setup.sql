-- Machine Templates Database Setup
...
-- Create machine_template_slots table for the slot configuration
...
-- Create company_machine_templates table (junction table for operators)
...
-- Create company_machine_template_slots table for company-specific slot configurations
...
-- RLS Policies for machine_categories (readable by all authenticated users, manageable by admins)
...
-- RLS Policies for machine_templates (readable by all authenticated users, manageable by admins)
...
-- RLS Policies for machine_template_slots (readable by all authenticated users, manageable by admins)
