...
export default function OperatorSidebar() {
  ...
  const navSections: NavSection[] = [
    ...
    },
    {
      ...
      items: [
        {
          href: '/operators/settings/basic-info',
          label: 'Basic Info',
          icon: (
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {
          href: '/operators/settings/contact-info',
          label: 'Contact Info',
          icon: (
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {
          href: '/operators/settings/primary-contact',
        ...
        {
          href: '/operators/settings/business-credentials',
        ...
        {
          href: '/operators/settings/location-service',
        ...
        {
          href: '/operators/settings/notifications',
          label: 'Notifications',
          icon: (
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {
          href: '/operators/settings/billing',
          label: 'Billing',
          icon: (
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {
          href: '/operators/settings/privacy',
          label: 'Privacy',
          icon: (
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {
          href: '/operators/settings/integrations',
          label: 'Integrations',
          icon: (
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {
          href: '/operators/settings/commission-settings',
        ...
        {
          href: '/operators/settings/payout-methods',
    ...
    },
    {
      ...
      items: [
        {
          href: '/operators/cashout-management',
    ...
    },
    {
      ...
      items: [
        {
          href: '/operators/global-machine-templates',
