          ...
          {loading ? (
            ...
            <>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                {company && (
                  <Link href="/operators/settings" className="block">
                    <div className="bg-white p-6 rounded-lg shadow-sm border hover:shadow-md transition-shadow">
                      ...
                      <p className="text-gray-600 mb-4">Manage business credentials and operational settings</p>
                ...
                <Link href="/operators/add-product" className="block">
                  <div className="bg-white p-6 rounded-lg shadow-sm border hover:shadow-md transition-shadow">
                    ...
                    <p className="text-gray-600 mb-4">Contribute to the global product catalog</p>
                    <div className="text-sm text-green-600">Add Product →</div>
                  </div>
                </Link>
                ...
                <Link href="/operators/customers" className="block">
                  <div className="bg-white p-6 rounded-lg shadow-sm border hover:shadow-md transition-shadow">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Customer Requests</h3>
                    <p className="text-gray-600 mb-4">Review and approve customer machine requests</p>
                    <div className="text-sm text-red-600">Review Requests →</div>
                  </div>
                </Link>
              </div>
