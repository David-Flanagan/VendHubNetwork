-- Fix RLS policies for customers table to work with users table (not user_roles)
-- This fixes the 406 error when accessing customers table
...
-- Recreate policies using the users table (not user_roles)
...
-- Success message
SELECT 'Customers table RLS policies fixed successfully!' as status; 