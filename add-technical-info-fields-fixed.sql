-- Add Technical Information Fields to Machine Templates (Fixed)
-- This migration adds only the missing technical fields to existing tables

-- Step 1: Add technical information fields to global_machine_templates (only if they don't exist)
...
-- Step 2: Add technical information fields to company_machine_templates (only if they don't exist)
...
-- Step 3: Create indexes for better performance on new fields (only if they don't exist)
