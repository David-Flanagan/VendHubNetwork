-- Machine Templates Revamp - Add New Fields
-- Run this in your Supabase SQL Editor

-- Add new fields to machine_templates table
...
-- Add new fields to company_machine_templates table (for custom overrides)
...
-- Add support for multiple product types per slot
-- Create a new table for slot product types (many-to-many relationship)
...
-- Create a new table for company slot product types
...
-- Verify the changes
SELECT 'machine_templates' as table_name, column_name, data_type 
FROM information_schema.columns 
WHERE table_name = 'machine_templates' 
AND column_name IN ('model_number', 'length_inches', 'width_inches', 'height_inches', 'is_outdoor_rated', 'technical_description')
