-- Final Fix for Machine Templates - Complete Solution
-- Run this in your Supabase SQL Editor to fix all machine template issues
...
-- 4. Drop all existing restrictive policies
